    ...
    <div class="about-me container">
      ...
      <div class="row">
        <div class="col-lg-4" data-aos="fade-right">
          <img src="{{ asset('assets/myfiles/images/ted1.png') }}" class="img-fluid" alt="">
        </div>
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                <li><i class="bi bi-chevron-right"></i> <strong>Country:</strong> <span>Kenya</span></li>
    ...
    <div class="skills container">
      ...
      <div class="row skills-content">
        ...
        <div class="col-lg-6">
          ...
          <div class="progress">
            <span class="skill">JavaScript <i class="val">78%</i></span>
            <div class="progress-bar-wrap">
        ...
        <div class="col-lg-6">
          ...
          <div class="progress">
            <span class="skill">Laravel <i class="val">92%</i></span>
            <div class="progress-bar-wrap">
          ...
          <div class="progress">
            <span class="skill">GraphQL <i class="val">80%</i></span>
            <div class="progress-bar-wrap">
    ...
    <div class="interests container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 mt-4">
          <div class="icon-box">
            <i class="ri-dashboard-line" style="color: #49a0af;"></i>
        ...
        <div class="col-lg-4 col-md-6 mt-4">
          <div class="icon-box">
            <i class="ri-coins-line" style="color: #726060;"></i>
            <h3>Fintech</h3>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mt-4">
          <div class="icon-box">
            <i class="ri-seedling-line" style="color: #6ce0a0;"></i>
            <h3>Agritech</h3>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mt-4">
          <div class="icon-box">
            <i class="ri-database-2-line" style="color: #d5eb10;"></i>
            <h3>Automation</h3>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mt-4">
          <div class="icon-box">
            <i class="ri-lightbulb-line" style="color: #ffffff;"></i>
            <h3>Innovation</h3>
          </div>
        </div>
      </div>
