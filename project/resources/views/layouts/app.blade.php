...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('assets/personal/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  <link href="{{ asset('assets/personal/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
  <link href="{{ asset('assets/personal/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
  <link href="{{ asset('assets/personal/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
  <link href="{{ asset('assets/personal/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
  <link href="{{ asset('assets/personal/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
