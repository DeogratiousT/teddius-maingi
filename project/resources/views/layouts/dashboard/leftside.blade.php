        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-2">
                    ...
                    <!--end::Name-->
                    <!--begin::Major-->
                    <span class="text-muted fw-bold d-block fs-7 lh-1">Software Developer</span>
                    <!--end::Major-->
                </div>
                <!--end::User info-->
            </div>
            ...
            <div class="ms-1">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                    ...
                    <div class="menu-item px-5">
                        <a id="logout-link" class="menu-link px-5" onclick="event.preventDefault();document.getElementById('logout-form2').submit();" href="{{ route('logout') }}"><i class="mdi mdi-logout mr-1"></i>Logout</a>
